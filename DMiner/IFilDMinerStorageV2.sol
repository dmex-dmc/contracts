...
contract IFilDMinerStorageV2  {
    ...
    struct IFilNFT {
        ...
        address     benefitsToken;      //benefits token
    }
    ...
    struct UserInfo {
        ...
        mapping(address => uint256) gainBenefits;
    }
    ...
    mapping(uint256 => uint256) internal _returnRates;
    mapping(uint256 => mapping(address => uint256)) internal _maxBuyPowers;
